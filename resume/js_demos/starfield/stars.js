...
Stars = {
  ...
  Defaults: {
    ...
    maxspeed:   10,
    layers: [
      { percent:  30, size: { min: 0.4, max: 1.0 }, speed: { min:   1, max:   2 }, colors: ['#111', '008080','#811'] }, // 1 in 3 get a tint of red
      { percent:  25, size: { min: 0.6, max: 1.0 }, speed: { min:   2, max:   4 }, colors: ['#37FDFC', '#008080', '#0EBFE9', '#FCD116'] }, // 1 in 3 get a tint of red
      { percent:  15, size: { min: 0.6, max: 1.2 }, speed: { min:   2, max:   4 }, colors: ['#333', '#333', '#833'] }, // 1 in 3 get a tint of red
 ...
 //     { percent:  15, size: { min: 1.0, max: 1.6 }, speed: { min:   8, max:  16 }, colors: ['#777'] },
      ...
      { percent:   2, size: { min: 1.6, max: 2.2 }, speed: { min:  64, max: 128 }, colors: ['#DDD', '#fff'] },
      { percent:   1, size: { min: 1.8, max: 2.4 }, speed: { min: 128, max: 256 }, colors: ['#fff', 'DDD', ] }
    ]
  },
